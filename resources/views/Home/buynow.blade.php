    ...
    <form action="/pay" method="POST">
                ...
                <div class=" row searched-item">
                    <div class="col-sm-2">
                        <a href="detail/{{ $item->id }}">
                            <img class="trending-image" style="width: 60px;height:70px;" src="{{ asset('uploads/' . $item->product_image) }}">
                        </a>
                    </div>
                    <div class="col-sm-2">
                        <div class="">
                            <p>{{ $item->product_name }}</p>
                            <input type="checkbox" name="product_id[]" hidden value={{ $item->id }}>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="">
        ...
        <div>
            <h4 style="margin-left: 310px;">Total Amount: <input type="text" style="width: 180px;"
                    value={{ $totalAmount }} name="totalAmount"></h4>
        </div>
        <div class="">
